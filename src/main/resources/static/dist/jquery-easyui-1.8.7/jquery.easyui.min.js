...
_520._unbind(".checkbox")._bind("change.checkbox",function(e){
return false;
});
if(opts.label){
if(typeof opts.label=="object"){
...
_527._unbind(".checkbox")._bind("click.checkbox",function(){
if(!opts.disabled&&!opts.readonly){
...
$(_543)._unbind(".validatebox");
if(opts.novalidate||opts.disabled){
return;
}
for(var _544 in opts.events){
$(_543)._bind(_544+".validatebox",{target:_543},opts.events[_544]);
}
};
function _545(e){
...
_59e._unbind(".textbox");
$(_59d.label)._unbind(".textbox");
if(!opts.disabled&&!opts.readonly){
if(_59d.label){
$(_59d.label)._bind("click.textbox",function(e){
if(!opts.hasFocusMe){
_59e.focus();
...
_59e._bind("blur.textbox",function(e){
...
_59e._bind(_59f+".textbox",{target:_59c},opts.inputEvents[_59f]);
}
}
var _5a0=tb.find(".textbox-addon");
_5a0._unbind()._bind("click",{target:_59c},function(e){
...
tb._unbind(".textbox")._bind("_resize.textbox",function(e,_5a3){
...
_610._unbind(".maskedbox");
for(var _611 in opts.inputEvents){
_610._bind(_611+".maskedbox",{target:_60f},opts.inputEvents[_611]);
}
});
}});
...
$(_68b)._bind("_resize",function(e,_68c){
...
$(_68e)._unbind(".calendar")._bind("mouseover.calendar",function(e){
var t=_690(e.target);
...
_765._unbind(".datagrid");
for(var _766 in opts.headerEvents){
_765._bind(_766+".datagrid",opts.headerEvents[_766]);
}
...
bb._bind(_766,opts.rowEvents[_766]);
}
...
_ae3.panel._unbind(".combo");
for(var _ae9 in opts.panelEvents){
_ae3.panel._bind(_ae9+".combo",{target:_ae2},opts.panelEvents[_ae9]);
}
};
function _aea(_aeb){
...
_c75._unbind(".datebox")._bind("click.datebox",function(e){
...
_cbc._bind("_resize",function(e,_cbd){
...
_cce.find("div.slider-inner")._unbind(".slider")._bind("mousedown.slider",function(e){
